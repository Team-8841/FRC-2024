...
public class Swerve extends SubsystemBase {
    ...
    public void PathPlannerSetup(){
        AutoBuilder.configureHolonomic(
            ...
            this::zeroPose, // Method to reset odometry (will be called if your auto has a starting pose)
            ...
            new HolonomicPathFollowerConfig( // HolonomicPathFollowerConfig, this should likely live in your Constants class
                    ...
                    0.4, // Drive base radius in meters. Distance from robot center to furthest module. // THIS needs to be changed
