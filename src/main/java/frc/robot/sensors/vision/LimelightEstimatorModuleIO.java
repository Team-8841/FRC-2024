...
public class LimelightEstimatorModuleIO implements EstimatorModuleIO {
  ...
  public Optional<PoseEstimate> getPoseEstimation(Pose2d currentEstimatedPose) {
    ...
    Translation3d estimatedTrans =
        new Translation3d(poseComponents[0], poseComponents[1], poseComponents[2]);
    Rotation3d estimatedRot =
        new Rotation3d(poseComponents[3], poseComponents[4], poseComponents[5]);
