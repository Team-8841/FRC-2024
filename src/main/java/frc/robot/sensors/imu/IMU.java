...
/**
 * Interface used by all IMU's. All implementing classes HAVE TO output orientations as CCW+
...
public abstract class IMU extends SubsystemBase {
  ...
  public void periodic() {
    ...
    Logger.processInputs("/IMU", this.inputs);
  }
  ...
  public void initializeShuffleBoardLayout(ShuffleboardLayout layout) {
    layout
        .addDouble("Heading", () -> this.getHeading().getDegrees())
   ...
   *
   * @return The current 3d orientation (pitch, roll, and yaw) of the IMU as a Rotation3d.
   */
