...
public final class MixedSwerveModuleIO implements SwerveModuleIO {
  ...
  private SimpleMotorFeedforward driveFeedforward =
      new SimpleMotorFeedforward(
          MixedMotorConstants.driveKS, MixedMotorConstants.driveKV, MixedMotorConstants.driveKA);
  ...
  private void configDriveMotor() {
    ...
    this.driveMotor.setInverted(
        SwerveConstants.driveMotorInvert == InvertedValue.Clockwise_Positive);
    this.driveMotor.setSmartCurrentLimit(
        SwerveConstants.drivePeakCurrentLimit, SwerveConstants.driveContinuousCurrentLimit);
  ...
  public SwerveModuleState getState() {
    ...
    return new SwerveModuleState(
        Conversions.rotsToMeters(
            this.driveMotor.getEncoder().getVelocity() / 60,
            SwerveConstants.wheelCircumference,
            SwerveConstants.driveGearRatio),
  ...
  public void initializeShuffleBoardLayout(ShuffleboardLayout layout) {
    ...
    layout.addDouble(
        "Angle Motor Stator Current", () -> this.angleStatorSignal.refresh().getValue());
    layout.addDouble(
        "Angle Motor Supply Current", () -> this.angleSupplySignal.refresh().getValue());
