...
public class OIConstants {
    ...
    public static final int buttonSel   = 7;    // Not used
    ...
    public static final int button1         = 1;    // Not used
    public static final int button2         = 2;    // Not used
    public static final int button3         = 3;    // Not used
    public static final int button4         = 4;    // Not used
    public static final int button5         = 5;    // Not used
    public static final int button6         = 6;    // Not used
    public static final int button7         = 7;    // Not used
    ...
    public static final int analog2         = 1;    // Not used
    public static final int analog3         = 2;    // Not used
    public static final int analog4         = 3;    // Not used
