...
public class SwerveConstants {
  ...
  // public static final double trackWidth = Units.inchesToMeters(22.75); // TODO: This must be
  // tuned to specific
  // robot
  public static final double trackWidth = Units.inchesToMeters(25);
  // public static final double wheelBase = Units.inchesToMeters(24.5); // TODO: This must be tuned
  // to specific
  // robot
  ...
  public static final InvertedValue angleMotorInvert =
      chosenModule.angleMotorInvert == InvertedValue.Clockwise_Positive
          ? InvertedValue.CounterClockwise_Positive
          : InvertedValue.Clockwise_Positive;
  public static final InvertedValue driveMotorInvert =
      chosenModule.driveMotorInvert == InvertedValue.Clockwise_Positive
          ? InvertedValue.CounterClockwise_Positive
          : InvertedValue.Clockwise_Positive;

  /* Angle Encoder Invert */
  public static final SensorDirectionValue canCoderDir =
      chosenModule.canCoderDir == SensorDirectionValue.Clockwise_Positive
